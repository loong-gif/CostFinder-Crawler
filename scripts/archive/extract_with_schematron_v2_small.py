...
async def fetch_webpage_text_via_firecrawl(url: str) -> Dict[str, str]:
...
def _build_messages(
    *,
    ...
    return [
        {"role": "system", "content": "You extract structured JSON from webpage markdown. Return JSON only."},
...
def main() -> None:
    ...
    source_doc = asyncio.run(fetch_webpage_text_via_firecrawl(args.url))
