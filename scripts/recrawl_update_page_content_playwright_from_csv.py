...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--cdp-url", default=os.getenv("CRAWL4AI_CDP_URL", "http://127.0.0.1:9222"), help="CDP endpoint URL")
        ...
        async def worker(url: str) -> None:
            async with semaphore:
                ...
                try:
                    ...
                    prep = prepare_page_content(rendered_text, source_type="markdown")
